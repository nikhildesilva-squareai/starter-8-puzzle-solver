...
![Beginner](https://img.shields.io/badge/difficulty-beginner-22C55E) ![Artificial Intelligence](https://img.shields.io/badge/course-Artificial%20Intelligence-0056CE) ![8 hours](https://img.shields.io/badge/estimated-8h-lightgrey)

> **Square 1 AI** starter template — Artificial Intelligence

## Overview

In this introductory project, you'll build a **8-Puzzle Solver** using Python, Heuristic Search. Solve the classic 8-puzzle using A* with Manhattan distance heuristic. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.

This project is part of the **Artificial Intelligence** course, where you'll implement classic AI algorithms from search and planning to game-playing agents.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-8-puzzle-solver.git
cd starter-8-puzzle-solver
...
This project builds skills directly applicable to roles like: **AI Engineer, Research Scientist, Algorithm Developer**.
